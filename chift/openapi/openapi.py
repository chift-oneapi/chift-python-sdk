...
#   timestamp: 2025-03-20T08:47:55+00:00
...
class AccountBalance(BaseModel):
    ...
    debit: float = Field(
        ...
        "then the "
        "debit and credit cannot be determined, only the balance can be calculated in those cases.",
        title="Debit",
    )
    credit: float = Field(
        ...,
    ...
    period_debit: float = Field(
        ...
        "are equal to 0 and "
        "balance is different from 0 then the debit and credit cannot be determined, only the balance can "
        "be calculated in those cases.",
        title="Period Debit",
    )
...
class AccountingCategoryItem(BaseModel):
    ...
    code: Optional[str] = Field(
        None, description="Code assigned to the category", title="Code"
    )
...
class AnalyticDistributionDetail(BaseModel):
    ...
    percentage: float = Field(
        ...,
        description="Indicates the percentage of the untaxed amount to attribute to the given analytic account (Only "
        "percentages without decimals are allowed).",
        title="Percentage",
    )
...
class BankingCounterPartItem(BaseModel):
    ...
    details: Optional[str] = Field(None, title="Details")
...
class CreateConsumerSyncItem(BaseModel):
    ...
    integrationids: Optional[List[str]] = Field(
        [],
        description="[OPTIONAL] Can be used to specify maximum one integrationid for each One API that you want to "
        "highlight. If specified, only this connector will be displayed to your clients.",
...
class FinancialEntryLineItem(BaseModel):
    ...
    account: str = Field(..., min_length=1, title="Account")
    amount: float = Field(
        ...,
        description="A positive amount represents funds transfered to the bank/cash account. In that case the "
        "bank/cash account is debited and the given account_number is credited.",
        title="Amount",
    )
    description: Optional[str] = Field(None, title="Description")
...
class InvoiceLineItemInMonoAnalyticPlan(BaseModel):
    ...
    tax_code: str = Field(
        ...,
        description="Indicates the tax code used for the line. This is the ID of the Tax Code in the accounting "
        "software.",
        min_length=1,
        title="Tax Code",
    )
...
class JournalItemMonoAnalyticPlan(BaseModel):
    ...
    currency: str = Field(..., min_length=1, title="Currency")
...
class OriginalOutstandingItem(BaseModel):
    ...
    date: Optional[datetime.date] = Field(None, title="Date")
...
class POSCustomerItem(BaseModel):
    ...
    birthdate: Optional[datetime.date] = Field(
        None, description="Birthdate", title="Birthdate"
    )
...
class PostAddressItem(BaseModel):
    ...
    number: Optional[str] = Field(None, title="Number")
    box: Optional[str] = Field(None, title="Box")
    city: str = Field(..., min_length=1, title="City")
    postal_code: str = Field(..., min_length=1, title="Postal Code")
    country: Optional[str] = Field(None, title="Country")


class PostConsumerItem(BaseModel):
    name: str = Field(..., max_length=255, min_length=1, title="Name")
    email: Optional[str] = Field(None, max_length=80, title="Email")
    internal_reference: Optional[str] = Field(
        None, max_length=255, title="Internal Reference"
    )
    redirect_url: Optional[str] = Field(None, max_length=255, title="Redirect Url")
...
class UpdateConsumerItem(BaseModel):
    name: Optional[str] = Field(None, max_length=255, title="Name")
    email: Optional[str] = Field(None, max_length=80, title="Email")
    internal_reference: Optional[str] = Field(
        None, max_length=255, title="Internal Reference"
    )
...
class WebhookInstancePostItem(BaseModel):
    ...
    signingsecret: Optional[str] = Field(None, max_length=100, title="Signingsecret")
    integrationid: Optional[int] = Field(
        None,
        description="Can be used to specify the integration code of a specific connector. This is mandatory in case "
        "you create a webhook related to a specific One API.",
        title="Integrationid",
    )
...
class BackboneApiAppRoutersConnectionsPostConnectionItem(BaseModel):
    integrationid: Optional[int] = Field(
        None,
        description="Can be used to specify the integration code of a specific connector. If specified, the url will "
        "will point directly to the connection page of the connector and will redirect on save to the "
        "redirect url of the consumer if specified.",
        title="Integrationid",
    )
    name: Optional[str] = Field(
        None,
        description="Can be used to specify the name of the connection. Must be used in combination with an "
        "integrationid.",
        title="Name",
    )
    credentials: Optional[List[BackboneApiAppRoutersConnectionsCredentialItem]] = Field(
        None,
        description="Can be used to specify the credentials of your connection. Must be used in combination with an "
        "integrationid and a name. Please use the getIntegrations route to see the available credentials "
...
class BackboneCommonModelsPosPmsDiscountItem(BaseModel):
    name: Optional[str] = Field(None, title="Name")
    total: float = Field(..., title="Total")
    type: Optional[DiscountType] = "UNKNOWN"
...
class ClientItemIn(BaseModel):
    ...
    first_name: Optional[str] = Field(
        None,
        description="Only used when the client is an individual (is_company=false). Indicates the first name of the "
        "client.",
        title="First Name",
    )
    last_name: Optional[str] = Field(
        None,
        description="Only used when the client is an individual (is_company=false). Indicates the last name of the "
        "client.",
        title="Last Name",
    )
    name: str = Field(..., min_length=1, title="Name")
    function: Optional[str] = Field(
        None,
        description="Only used when the client is an individual (is_company=false). Indicates the function of the "
        "client.",
        title="Function",
    )
    ...
    company_id: Optional[str] = Field(
        None,
        description="Only used when the client is an individual (is_company=false). Indicates the id of the company "
...
class FinancialEntryItemIn(BaseModel):
    ...
    currency_exchange_rate: Optional[float] = Field(
        ...
        "creating the "
        "operation in another currency from the default currency of the accounting system.",
...
class GenericJournalItem(BaseModel):
    ...
    force_general_account: Optional[str] = Field(
        None,
        description="For ustomer/supplier/employee accounts we determine the general account based on the "
        "configurations in the accounting system. The general account can also be forced by specifying the "
        "value in this field.",
        title="Force General Account",
    )
    prioritise_thirdparty_account: Optional[bool] = Field(
        False,
        description="Indicate if we need to prioritise the information from thirdparty accounts when forcing the "
        "general account in a software where only 1 account is accepted.",
    ...
    tax_code: Optional[str] = Field(
        None,
        description="Indicates the tax code used for the entry item. This is the ID of the Tax Code in the accounting "
        "software.",
        title="Tax Code",
    )
...
class IntegrationItem(BaseModel):
    ...
    credentials: Optional[List[BackboneApiAppRoutersIntegrationsCredentialItem]] = (
        Field(
            [],
            description="List of credentials that must be specified to create a connection. Can be used if you want to "
            "pass credentials on connection creation. Not compatible with oAuth2 routes.",
            title="Credentials",
        )
    )
...
class InvoiceItemOutMonoAnalyticPlan(BaseModel):
    ...
    invoice_number: Optional[str] = Field(
        None,
        description="Number of the invoice. If left empty, will be automatically generated by the accounting system at "
        "creation.",
    ...
    journal_id: str = Field(
        ...,
        description="Indicates the journal used in for the invoice. If the journal is not given, the journal will be "
        "automatically set if only one journal exists otherwise an error will be thrown.",
        title="Journal Id",
    )
...
class JournalEntryMonoAnalyticPlan(BaseModel):
    ...
    date: Optional[datetime.date] = Field(
        ...
        "value is not "
        "available/empty in the accounting system.",
        title="Date",
    )
...
class OpportunityItem(BaseModel):
    ...
    due_date: Optional[datetime.date] = Field(
        None, description="Due Date", title="Due Date"
    )
    end_date: Optional[datetime.date] = Field(
        None, description="End Date", title="End Date"
    )
...
class PMSOrderLineItem(BaseModel):
    ...
    type: Optional[POSLineItemType] = None
    menu_id: Optional[str] = Field(None, title="Menu Id")
    quantity: float = Field(..., title="Quantity")
    unit_price: float = Field(..., title="Unit Price")
    total: float = Field(..., title="Total")
    tax_amount: float = Field(..., title="Tax Amount")
...
class PMSPaymentItem(BaseModel):
    ...
    date: Optional[datetime.datetime] = Field(None, title="Date")
...
class POSCreateCustomerItem(BaseModel):
    ...
    last_name: str = Field(..., min_length=1, title="Last Name")
    phone: Optional[str] = Field(None, title="Phone")
    email: Optional[str] = Field(None, title="Email")
...
class POSProductItem(BaseModel):
    id: str = Field(..., title="Id")
    categories: Optional[List[str]] = Field([], title="Categories")
    name: str = Field(..., title="Name")
    description: Optional[str] = Field(None, title="Description")
    ...
    accounting_category_ids: Optional[List[str]] = Field(
        None,
        description="Used by a POS to give one or more specific accounting categories to a product item. If not "
        "available it will use the category ids",
...
class PatchConnectionItem(BaseModel):
    ...
    credentials: Optional[List[BackboneApiAppRoutersConnectionsCredentialItem]] = Field(
        None,
        description="Can be used to update the credentials of an existing connection. Please use the getIntegrations "
        "route to see the available credentials for each integration",
        title="Credentials",
    )
...
class ProductItemOut(BaseModel):
    ...
    available_quantity: Optional[float] = Field(
        0,
        description="Available quanity of the product in stock. Will only be used for products that have an inventory "
...
class SupplierItemIn(BaseModel):
    ...
    first_name: Optional[str] = Field(
        None,
        description="Only used when the supplier is an individual (is_company=false). Indicates the first name of the "
        "supplier.",
        title="First Name",
    )
    last_name: Optional[str] = Field(
        None,
        description="Only used when the supplier is an individual (is_company=false). Indicates the last name of the "
        "supplier.",
        title="Last Name",
    )
    name: str = Field(..., min_length=1, title="Name")
    function: Optional[str] = Field(
        None,
        description="Only used when the supplier is an individual (is_company=false). Indicates the function of the "
        "supplier.",
        title="Function",
    )
    is_company: Optional[bool] = Field(
    ...
    company_id: Optional[str] = Field(
        None,
        description="Only used when the supplier is an individual (is_company=false). Indicates the id of the company "
...
class WebhookInstancePatchItem(BaseModel):
    ...
    url: Optional[str] = Field(None, max_length=500, title="Url")
    signingsecret: Optional[str] = Field(None, max_length=100, title="Signingsecret")
...
class GenericJournalEntry(BaseModel):
    ...
    due_date: Optional[datetime.date] = Field(None, title="Due Date")
    journal_id: str = Field(..., title="Journal Id")
    number: str = Field(..., min_length=1, title="Number")
    currency: str = Field(..., min_length=1, title="Currency")
    currency_exchange_rate: Optional[float] = Field(1, title="Currency Exchange Rate")
    date: datetime.date = Field(..., title="Date")
...
class InvoiceItemInMonoAnalyticPlan(BaseModel):
    ...
    partner_id: str = Field(..., min_length=1, title="Partner Id")
    ...
    currency_exchange_rate: Optional[float] = Field(
        ...
        "the "
        "invoice in another currency from the default currency of the accounting system.",
        title="Currency Exchange Rate",
    )
    invoice_correction: Optional[InvoiceCorrection] = Field(
        None,
        description="Information used to add a correction line when roundings have an impact on the total amount of "
        "the invoice.",
...
class MiscellaneousOperationIn(BaseModel):
    ...
    journal_id: Optional[str] = Field(
        None,
        description="Indicates the journal used in for the operation. If the journal is not given, the journal will be "
        "automatically set if only one journal exists otherwise an error will be thrown.",
        title="Journal Id",
    )
...
class PMSOrderItem(BaseModel):
    ...
    total: float = Field(..., title="Total")
    tax_amount: float = Field(..., title="Tax Amount")
    total_discount: Optional[float] = Field(0, title="Total Discount")
    total_refund: Optional[float] = Field(0, title="Total Refund")
    total_tip: Optional[float] = Field(0, title="Total Tip")
    delivery_fee: Optional[float] = Field(0, title="Delivery Fee")
    currency: Optional[str] = Field(None, title="Currency")
    country: Optional[str] = Field(None, title="Country")
    loyalty: Optional[int] = Field(None, title="Loyalty")
    customer_id: Optional[str] = Field(None, title="Customer Id")
    ...
    taxes: Optional[List[TotalTaxItem]] = Field(None, title="Taxes")
    guests: Optional[int] = Field(None, title="Guests")
    items: List[PMSOrderLineItem] = Field(..., title="Items")
    service_id: Optional[str] = Field(
        None,
        description="Reference to the service related to this order",
...
class POSOrderItem(BaseModel):
    ...
    taxes: Optional[List[TotalTaxItem]] = Field(None, title="Taxes")
    guests: Optional[int] = Field(None, title="Guests")
    payments: List[POSPaymentItem] = Field(..., title="Payments")
    items: List[POSItem] = Field(..., title="Items")
...
class ReadFlowItem(BaseModel):
    ...
    config: Optional[FlowConfig] = Field(
        default_factory=lambda: FlowConfig.model_validate({"datastores": []}),
        title="Config",
    )
...
class BackboneCommonModelsInvoicingCommonInvoiceItem(BaseModel):
    ...
    invoice_date: datetime.date = Field(
        ..., description="Invoicing datetime.date", title="Invoice Date"
    )
    ...
    due_date: Optional[datetime.date] = Field(
        None, description="Due datetime.date", title="Due Date"
    )
...
class OrderItemOut(BaseModel):
    ...
    untaxed_amount_without_fees: float = Field(
        ...,
        description="Untaxed amount without fees (e.g. shipping) but with discout. Refunds and returns are not "
        "included.",
    ...
    total_without_fees: float = Field(
        ...,
        description="Total of the order without fees (e.g. shipping) but with discount. Refunds and returns are not "
        "included.",
        title="Total Without Fees",
    )
    current_untaxed_amount: float = Field(
        ...,
        description="Untaxed amount with discout and any kind of fee (e.g. shipping). After returns, removes and "
        "returns.",
    ...
    untaxed_amount: float = Field(
        ...,
        description="Untaxed amount with discout and any kind of fee (e.g. shipping). Refunds and returns are not "
        "included.",
        title="Untaxed Amount",
    )
    tax_amount: float = Field(
