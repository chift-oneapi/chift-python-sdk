...
#   timestamp: 2025-04-24T14:21:42+00:00
...
class BookYear(BaseModel):
    name: str = Field(..., title="Name")
    start: date_aliased = Field(..., title="Start")
    end: date_aliased = Field(..., title="End")
...
class ConnectionItemInput(BaseModel):
    one_api: Optional[int_aliased] = Field(None, title="One Api")
    connection_type: Optional[int_aliased] = Field(None, title="Connection Type")
    display_order: Optional[int_aliased] = Field(0, title="Display Order")
...
class InvoiceLineItemInMonoAnalyticPlan(BaseModel):
    line_number: Optional[int_aliased] = Field(1, title="Line Number")
...
class IssueItem(BaseModel):
    ...
    integration_id: int_aliased = Field(..., title="Integration Id")
    ...
    error: ErrorInfo
    occurrences: int_aliased = Field(..., title="Occurrences")
...
class LinkedDeposits(BaseModel):
    id: Optional[str] = Field(
        ..., description="Technical id of the deposit in Chift", title="Id"
    )
    amount: Optional[float] = Field(
        ..., description="Amount of the deposit", title="Amount"
    )
...
class LogoImage(BaseModel):
    integrationid: int_aliased = Field(..., title="Integrationid")
...
class NextDocumentNumber(BaseModel):
    ...
    start_date: Optional[date_aliased] = Field(None, title="Start Date")
...
class OrderLineItemIn(BaseModel):
    ...
    quantity: int_aliased = Field(..., title="Quantity")
    tax_rate: float = Field(
        ...,
        description="Indicates the tax rate used for the line (e.g. 21.0).",
        title="Tax Rate",
...
class OriginalOutstandingItem(BaseModel):
    ...
    due_date: Optional[date_aliased] = Field(None, title="Due Date")
    reference: Optional[str] = Field(None, title="Reference")
...
class POSCustomerItem(BaseModel):
    ...
    loyalty: Optional[int_aliased] = Field(
        None,
        description="Loyalty points of the customer",
        examples=[100],
        title="Loyalty",
    )
    birthdate: Optional[date_aliased] = Field(
        None,
...
class Payment(BaseModel):
    ...
    payment_date: date_aliased = Field(..., title="Payment Date")
    journal_type: JournalType
    journal_id: str = Field(..., title="Journal Id")
...
class PostConnectionItemInput(BaseModel):
    integrationid: Optional[int_aliased] = Field(
        None,
...
class Token(BaseModel):
    ...
    expires_in: int_aliased = Field(..., title="Expires In")
    expires_on: int_aliased = Field(..., title="Expires On")
...
class ValidationError(BaseModel):
    loc: List[Union[str, int_aliased]] = Field(..., title="Location")
...
class WebhookInstanceGetItem(BaseModel):
    ...
    url: str = Field(..., title="Url")
    status: Status
    integrationid: Optional[int_aliased] = Field(None, title="Integrationid")
...
class WebhookLogItem(BaseModel):
    ...
    createdon: DateTime = Field(..., title="Createdon")
    httpstatus: int_aliased = Field(..., title="Httpstatus")
    integrationid: Optional[int_aliased] = Field(None, title="Integrationid")
...
class InvoicingPaymentItem(BaseModel):
    ...
    partner_id: Optional[str] = Field(..., description="Partner ID", title="Partner Id")
    payment_method_id: Optional[str] = Field(
        None,
...
class MiscellaneousOperationOut(BaseModel):
    ...
    operation_date: Optional[date_aliased] = Field(
        "1970-01-01",
...
class OpportunityItem(BaseModel):
    ...
    created_date: Optional[date_aliased] = Field(
        None, description="Date creation", title="Created Date"
    )
    due_date: Optional[date_aliased] = Field(
        None, description="Due Date", title="Due Date"
    )
    end_date: Optional[date_aliased] = Field(
...
class VariantItem(BaseModel):
    ...
    unit_cost: Optional[ProductCostItem] = {}
    unit_of_measure: Optional[str] = Field(None, title="Unit Of Measure")
    weight: Optional[float] = Field(0, title="Weight")
    weight_unit: Optional[str] = Field(None, title="Weight Unit")
    status: Optional[ProductStatus] = None
...
class InvoiceItemInMonoAnalyticPlan(BaseModel):
    ...
    payment_communication: Optional[str] = Field(None, title="Payment Communication")
    customer_memo: Optional[str] = Field(None, title="Customer Memo")
    invoice_date: date_aliased = Field(..., title="Invoice Date")
    due_date: date_aliased = Field(..., title="Due Date")
...
class MiscellaneousOperationIn(BaseModel):
    ...
    lines: List[MiscellaneousOperationLine] = Field(..., title="Lines")
    operation_date: date_aliased = Field(..., title="Operation Date")
    journal_id: Optional[str] = Field(
        None,
...
class OrderLineItemOut(BaseModel):
    ...
    quantity: int_aliased = Field(..., title="Quantity")
    current_quantity: int_aliased = Field(
        ...,
...
class PMSOrderItem(BaseModel):
    ...
    guests: Optional[int_aliased] = Field(
        None,
...
class InvoiceItemInput(BaseModel):
    ...
    invoice_date: date_aliased = Field(
        ..., description="Invoicing date", title="Invoice Date"
    )
    ...
    is_deposit: Optional[bool] = Field(False, title="Is Deposit")
    linked_deposits: Optional[List[LinkedDeposits]] = Field(
        [], description="Linked deposit", title="Linked Deposits"
    )
...
class InvoiceItemOut(BaseModel):
    ...
    accounting_date: Optional[date_aliased] = Field(
