...
#   timestamp: 2024-11-12T21:13:07+00:00
...
class AccountToCreate(BaseModel):
    account_number: constr(min_length=4) = Field(..., title="Account Number")
...
class BackboneApiAppRoutersAccountingInvoiceType(Enum):
    customer_invoice = "customer_invoice"
    customer_refund = "customer_refund"
    supplier_invoice = "supplier_invoice"
    supplier_refund = "supplier_refund"
...
class BackboneApiAppRoutersAccountingVatCodeScope(Enum):
    nat = "nat"
    eu = "eu"
    int = "int"
    unknown = "unknown"
...
class BackboneApiAppRoutersAccountingVatCodeType(Enum):
    sale = "sale"
    purchase = "purchase"
    both = "both"
    unknown = "unknown"
...
class BackboneApiAppRoutersCommerceAddressItemIn(BaseModel):
...
class BackboneApiAppRoutersCommerceAddressItemOut(BaseModel):
...
class BackboneApiAppRoutersCommerceDiscountItem(BaseModel):
    name: str = Field(..., title="Name")
    description: str = Field(..., title="Description")
    amount: float = Field(..., title="Amount")


class BackboneApiAppRoutersCommerceProductCategoryItem(BaseModel):
    id: str = Field(
...
class BackboneApiAppRoutersCommerceProductPriceItem(BaseModel):
    currency: str = Field(..., title="Currency")
...
class BackboneApiAppRoutersPosProductCategoryItem(BaseModel):
    id: str = Field(..., title="Id")
    name: str = Field(..., title="Name")
    description: Optional[str] = Field(None, title="Description")
...
class BackboneApiAppRoutersPosProductPriceItem(BaseModel):
    unit_price: float = Field(..., title="Unit Price")
...
class BackboneCommonModelsInvoicingInvoiceType(Enum):
    customer_invoice = "customer_invoice"
    customer_refund = "customer_refund"
    supplier_invoice = "supplier_invoice"
    supplier_refund = "supplier_refund"
...
class BackboneCommonModelsInvoicingProductItem(BaseModel):
...
class BackboneCommonModelsInvoicingVatCodeScope(Enum):
    nat = "nat"
    eu = "eu"
    int = "int"
    unknown = "unknown"
...
class BackboneCommonModelsInvoicingVatCodeType(Enum):
    sale = "sale"
    purchase = "purchase"
    both = "both"
    unknown = "unknown"
...
class BackboneCommonModelsPaymentPaymentStatus(Enum):
    pending = "pending"
    completed = "completed"
    canceled = "canceled"
    failed = "failed"
...
class ChiftPageProductCategoryItem(BaseModel):
    items: List[BackboneApiAppRoutersPosProductCategoryItem] = Field(..., title="Items")
    total: conint(ge=0) = Field(..., title="Total")
    page: conint(ge=1) = Field(..., title="Page")
    size: conint(ge=1) = Field(..., title="Size")
...
class CommerceCustomerItem(BaseModel):
    ...
    addresses: Optional[List[BackboneApiAppRoutersCommerceAddressItemOut]] = Field(
        [], title="Addresses"
    )
    created_on: Optional[datetime] = Field(None, title="Created On")
...
class FeesItem(BaseModel):
    ...
    discounts: Optional[List[BackboneApiAppRoutersCommerceDiscountItem]] = Field(
        [], title="Discounts"
    )
    untaxed_amount: float = Field(..., title="Untaxed Amount")
    tax_amount: float = Field(..., title="Tax Amount")
...
class InvoiceItemOut(BaseModel):
    ...
    invoice_type: BackboneCommonModelsInvoicingInvoiceType = Field(
...
class InvoiceItemOutMonoAnalyticPlan(BaseModel):
    invoice_type: BackboneApiAppRoutersAccountingInvoiceType
    invoice_number: Optional[str] = Field(
        None,
...
class OrderItemIn(BaseModel):
    ...
    billing_address: BackboneApiAppRoutersCommerceAddressItemIn
    shipping_address: BackboneApiAppRoutersCommerceAddressItemIn
    currency: str = Field(
        ...,
...
class POSProductItem(BaseModel):
    ...
    name: str = Field(..., title="Name")
    description: Optional[str] = Field(None, title="Description")
    prices: List[BackboneApiAppRoutersPosProductPriceItem] = Field(..., title="Prices")
...
class PaymentItemOut(BaseModel):
    ...
    status: BackboneCommonModelsPaymentPaymentStatus = Field(
...
class ProductVariantItem(BaseModel):
    ...
    prices: Optional[List[BackboneApiAppRoutersCommerceProductPriceItem]] = Field(
        [], title="Prices"
    )
...
class BackboneApiAppRoutersAccountingVatCode(BaseModel):
    id: str = Field(..., title="Id")
    code: Optional[str] = Field(None, title="Code")
    label: str = Field(..., title="Label")
    scope: Optional[BackboneApiAppRoutersAccountingVatCodeScope] = "unknown"
    rate: float = Field(..., title="Rate")
    type: BackboneApiAppRoutersAccountingVatCodeType
...
class BackboneApiAppRoutersCommerceProductItem(BaseModel):
    id: str = Field(..., description="Technical id in Chift", title="Id")
    source_ref: Ref = Field(
        ..., description="Technical id in the target software", title="Source Ref"
    )
...
class BackboneApiAppRoutersPmsInvoiceItem(BaseModel):
    id: str = Field(..., description="Technical id in Chift", title="Id")
    source_ref: Ref = Field(
        ..., description="Technical id in the target software", title="Source Ref"
    )
...
class BackboneCommonModelsInvoicingInvoiceItem(BaseModel):
    currency: str = Field(
        ..., description="Currency matching target sofware name", title="Currency"
    )
    invoice_type: BackboneCommonModelsInvoicingInvoiceType = Field(
...
class BackboneCommonModelsInvoicingVatCode(BaseModel):
    id: str = Field(..., description="Technical id in Chift", title="Id")
    source_ref: Ref = Field(
        ..., description="Technical id in the target software", title="Source Ref"
    )
    ...
    type: BackboneCommonModelsInvoicingVatCodeType = Field(..., description="Type")
    code: Optional[str] = Field(None, description="Code", title="Code")
    scope: Optional[BackboneCommonModelsInvoicingVatCodeScope] = Field(
...
class ChiftPageProductItem(BaseModel):
    items: List[BackboneApiAppRoutersCommerceProductItem] = Field(..., title="Items")
    total: conint(ge=0) = Field(..., title="Total")
    page: conint(ge=1) = Field(..., title="Page")
    size: conint(ge=1) = Field(..., title="Size")
...
class PMSOrderItem(BaseModel):
    ...
    bills: Optional[List[BackboneApiAppRoutersPmsInvoiceItem]] = Field(
...
class BackboneApiAppRoutersAccountingChiftPageVatCode(BaseModel):
    items: List[BackboneApiAppRoutersAccountingVatCode] = Field(..., title="Items")
    total: conint(ge=0) = Field(..., title="Total")
    page: conint(ge=1) = Field(..., title="Page")
    size: conint(ge=1) = Field(..., title="Size")


class BackboneApiAppRoutersInvoicingChiftPageVatCode(BaseModel):
    items: List[BackboneCommonModelsInvoicingVatCode] = Field(..., title="Items")
    total: conint(ge=0) = Field(..., title="Total")
    page: conint(ge=1) = Field(..., title="Page")
    size: conint(ge=1) = Field(..., title="Size")
...
class OrderItemOut(BaseModel):
    ...
    billing_address: Optional[BackboneApiAppRoutersCommerceAddressItemOut] = None
    shipping_address: Optional[BackboneApiAppRoutersCommerceAddressItemOut] = None
    created_on: Optional[datetime] = Field(None, title="Created On")
    last_updated_on: Optional[datetime] = Field(None, title="Last Updated On")
