...
#   timestamp: 2026-01-19T10:44:52+00:00
...
class DataStoreItem(BaseModel):
    id: str = Field(..., title="Id")
    name: str = Field(..., title="Name")
    status: Optional[BackboneApiAppRoutersIntegrationsStatus] = "active"
...
class WebhookInstancePatchItem(BaseModel):
    status: Optional[BackboneApiAppRoutersIntegrationsStatus] = None
