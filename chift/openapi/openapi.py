...
class FlowTriggerTimer(BaseModel):
    cronschedule: Optional[str] = Field("*/5 * * * *", title="Cronschedule")
...
class InvoiceLineItem(BaseModel):
    description: str = Field(..., description="Line description", title="Description")
...
class FlowConfig(BaseModel):
    ...
    datastores: Optional[List[DataStoreItem]] = Field([], title="Datastores")
