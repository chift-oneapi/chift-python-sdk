...
#   timestamp: 2025-04-17T15:44:52+00:00
...
class InvoicingPaymentItem(BaseModel):
    ...
    payment_method_name: str = Field(
        ..., description="Payment method name", title="Payment Method Name"
    )
    invoice_id: str = Field(
        ..., description="Technical id of the invoice in Chift", title="Invoice Id"
    )
    invoice_number: str = Field(
        ..., description="Invoice number", title="Invoice Number"
    )
...
class InvoiceItemOutput(BaseModel):
    ...
    source_ref: Ref = Field(..., description="Technical id in the target software")
    invoice_number: Optional[str] = Field(
        ..., description="Number/sequence", example="INV-12345", title="Invoice Number"
    )
    creation_date: Optional[datetime] = Field(
        None,
