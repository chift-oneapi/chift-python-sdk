...
#   timestamp: 2024-01-26T10:08:47+00:00
...
class PageAccountingCategoryItem(BaseModel):
...
class PageBankingCounterPartItem(BaseModel):
...
class BackboneApiAppRoutersPosDiscountItem(BaseModel):
    name: Optional[str] = Field(None, title="Name")
    total: float = Field(..., title="Total")


class BackboneApiAppRoutersPosPaymentStatus(Enum):
    Pending = "Pending"
    Completed = "Completed"
    Canceled = "Canceled"
    Failed = "Failed"
...
class Item(BaseModel):
    ...
    description: str = Field(..., title="Description")
    discounts: Optional[List[BackboneApiAppRoutersPosDiscountItem]] = Field(
        [], title="Discounts"
    )
    product_id: Optional[str] = Field(
        None,
...
class PageCategoryItem(BaseModel):
...
class PagePOSProductItem(BaseModel):
...
class PageProductCategoryItem(BaseModel):
...
class PageTaxRateItem(BaseModel):
...
class PaymentItem(BaseModel):
    ...
    status: Optional[BackboneApiAppRoutersPosPaymentStatus] = "Unknown"
...
class PagePaymentMethodItem(BaseModel):
...
class BackboneApiAppRoutersAccountingPageVatCode(BaseModel):
...
class BackboneApiAppRoutersInvoicingPageVatCode(BaseModel):
