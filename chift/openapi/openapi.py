...
#   timestamp: 2025-03-27T14:58:09+00:00
...
class InvoicePartnerItem(BaseModel):
    ...
    type: PartnerType = Field(..., description="Type of the partner")
    address: Optional[AddressItem] = Field(
...
class PMSCustomerItem(BaseModel):
    ...
    phone: Optional[str] = Field(
        None, description="Phone number of the customer", title="Phone"
    )
    email: Optional[str] = Field(
        None, description="Email address of the customer", title="Email"
    )
    account_number: Optional[str] = Field(
        None,
        description="Number of the accounting account used (e.g. 701000)",
    ...
    created_on: Optional[datetime] = Field(
        None, description="Creation date of the customer", title="Created On"
    )
    addresses: Optional[List[AddressItem]] = Field(
...
class PMSTaxRateItem(BaseModel):
    ...
    label: Optional[str] = Field(
        None, description="Label of the tax rate", title="Label"
    )
    percentage: Optional[float] = Field(
        None, description="Percentage of the tax rate", title="Percentage"
    )
...
class ReservationItem(BaseModel):
    ...
    start_date: Optional[datetime] = Field(
        None, description="Start date of the reservation", title="Start Date"
    )
    end_date: Optional[datetime] = Field(
        None, description="End date of the reservation", title="End Date"
    )
    creation_date: Optional[datetime] = Field(
        None, description="Creation date of the reservation", title="Creation Date"
    )
...
class BackboneCommonModelsPmsCommonInvoiceItem(BaseModel):
    ...
    creation_date: Optional[datetime] = Field(
        None, description="Creation date of the invoice", title="Creation Date"
    )
    closing_date: Optional[datetime] = Field(
        None, description="Closing date of the invoice", title="Closing Date"
    )
