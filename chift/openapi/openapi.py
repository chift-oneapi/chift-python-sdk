...
#   timestamp: 2025-07-17T09:56:21+00:00
...
class BackboneCommonModelsAccountingCommonAnalyticDistributionDetail(BaseModel):
...
class BackboneCommonModelsAccountingCommonAnalyticPlanItem(BaseModel):
    id: str = Field(
        ...,
...
class BackboneCommonModelsInvoicingCommonAnalyticDistributionDetail(BaseModel):
...
class BackboneCommonModelsInvoicingCommonAnalyticPlanItem(BaseModel):
    id: str = Field(
        ...,
        description="Unique id of the analytic plan instance in the invoicing system.",
        title="Id",
    )
    name: str = Field(
        ...,
        description="Name of the analytic plan as it appears in the invoicing system.",
        title="Name",
    )
    active: Optional[bool] = Field(
        True, description="Indicates if the analytic plan is active.", title="Active"
...
class BackboneApiAppRoutersHelpersResponseChiftPageAnalyticPlanItem1(BaseModel):
    items: List[BackboneCommonModelsAccountingCommonAnalyticPlanItem] = Field(
        ..., title="Items"
    )
    total: Optional[conint(ge=0)] = Field(None, title="Total")
    page: conint(ge=1) = Field(..., title="Page")
...
class BackboneApiAppRoutersHelpersResponseChiftPageAnalyticPlanItem2(BaseModel):
    items: List[BackboneCommonModelsInvoicingCommonAnalyticPlanItem] = Field(
        ..., title="Items"
    )
    total: Optional[conint(ge=0)] = Field(None, title="Total")
    page: conint(ge=1) = Field(..., title="Page")
...
class BackboneCommonModelsAccountingCommonAnalyticDistribution(BaseModel):
    analytic_plan: str = Field(
        ...,
        description="Id of the analytic plan to which the distribution applies.",
        title="Analytic Plan",
    )
    analytic_accounts: List[
        BackboneCommonModelsAccountingCommonAnalyticDistributionDetail
    ] = Field(
        ...,
...
class BackboneCommonModelsInvoicingCommonAnalyticDistribution(BaseModel):
    analytic_plan: str = Field(
        ...,
        description="Id of the analytic plan to which the distribution applies.",
        title="Analytic Plan",
    ...
    analytic_accounts: List[
        BackboneCommonModelsInvoicingCommonAnalyticDistributionDetail
    ] = Field(
        ...,
        description="List of analytic accounts and their respective percentages for the distribution.",
        title="Analytic Accounts",
...
class GenericJournalItem(BaseModel):
    ...
    analytic_distribution: Optional[
        List[BackboneCommonModelsAccountingCommonAnalyticDistribution]
    ] = Field(
        [],
...
class InvoiceLineItemInput(BaseModel):
    ...
    analytic_distribution: Optional[
        List[BackboneCommonModelsInvoicingCommonAnalyticDistribution]
    ] = Field(
        [],
...
class InvoiceLineItemInMultiAnalyticPlans(BaseModel):
    ...
    analytic_distribution: Optional[
        List[BackboneCommonModelsAccountingCommonAnalyticDistribution]
    ] = Field([], title="Analytic Distribution")
...
class JournalEntryIn(BaseModel):
    ...
    date: Date = Field(
        ...,
        description="Accounting date of the journal entry (format: YYYY-MM-DD).",
        title="Date",
    )
    items: List[JournalItemIn] = Field(
        ...,
        description="List of journal items that make up the journal entry. Each item represents a line in the journal entry, and the sum of debits must equal the sum of credits to ensure the entry is balanced. There must always be at least 2 lines/items.",
        min_length=2,
        title="Items",
