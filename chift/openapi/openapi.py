...
#   timestamp: 2026-01-22T10:40:32+00:00
...
class BackboneCommonModelsAccountingCommonDocumentType(Enum):
    invoice = "invoice"
    entry = "entry"
...
class BackboneCommonModelsAccountingCommonWithholdingTax(BaseModel):
    tax_rate: float = Field(
        ...,
...
class BackboneCommonModelsInvoicingCommonDocumentType(Enum):
...
class BackboneCommonModelsInvoicingCommonWithholdingTax(BaseModel):
...
class AccountingVatCode(BaseModel):
    ...
    scope: Optional[BackboneCommonModelsAccountingCommonVatCodeScope] = Field(
        "unknown",
    ...
    type: BackboneCommonModelsAccountingCommonVatCodeType = Field(
        ...,
...
class AttachmentItemIn(BaseModel):
    base64_string: str = Field(..., title="Base64 String")
    document_type: BackboneCommonModelsInvoicingCommonDocumentType
...
class DataStoreItem(BaseModel):
    id: str = Field(..., title="Id")
    name: str = Field(..., title="Name")
    status: Optional[BackboneApiAppRoutersWebhooksStatus] = "active"
...
class InvoiceItemInMonoAnalyticPlan(BaseModel):
    ...
    withholding_tax: Optional[BackboneCommonModelsAccountingCommonWithholdingTax] = (
        Field(None, description="Withholding tax information for the invoice.")
    )
...
class ItalianSpecificitiesInput(BaseModel):
    ...
    withholding_tax: Optional[BackboneCommonModelsInvoicingCommonWithholdingTax] = (
        Field(None, description="Withholding tax (specific to Italy)")
    )
...
class UploadDocumentItemOut(BaseModel):
    ...
    invoice_type: Optional[BackboneCommonModelsInvoicingCommonInvoiceType] = Field(
