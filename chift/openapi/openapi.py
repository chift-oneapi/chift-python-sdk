...
class AccountToCreate(BaseModel):
    account_number: str = Field(..., min_length=1, title="Account Number")
    account_name: str = Field(..., min_length=1, title="Account Name")
...
class ChiftPageAccountBalance(BaseModel):
    ...
    total: Optional[Total] = Field(None, title="Total")
...
class InventoryDetailsUpdate(BaseModel):
    ...
    available_quantity: float = Field(..., ge=0.0, title="Available Quantity")
...
class LedgerAccountItemIn(BaseModel):
    ...
    type: Optional[AccountItemType] = "other"
...
class PostAddressItem(BaseModel):
    ...
    city: str = Field(
        ..., description="City name", examples=["Paris"], min_length=1, title="City"
    )
...
class InternalReference(RootModel[str]):
    root: str = Field(
        ...,
        description="Your internal reference for the client (e.g., customer ID or unique identifier in your system).",
        max_length=255,
...
class PostConsumerItem(BaseModel):
    ...
    internal_reference: Optional[InternalReference] = Field(
        None,
        description="Your internal reference for the client (e.g., customer ID or unique identifier in your system).",
        title="Internal Reference",
    )
...
class Url(RootModel[str]):
    root: str = Field(..., max_length=500, title="Url")


class Signingsecret(RootModel[str]):
    root: str = Field(..., max_length=100, title="Signingsecret")


class WebhookInstancePatchItem(BaseModel):
    status: Optional[Status] = None
    url: Optional[Url] = Field(None, title="Url")
    signingsecret: Optional[Signingsecret] = Field(None, title="Signingsecret")


class WebhookInstancePostItem(BaseModel):
    event: str = Field(..., max_length=80, title="Event")
    url: str = Field(..., max_length=500, title="Url")
    signingsecret: Optional[Signingsecret] = Field(None, title="Signingsecret")
    integrationid: Optional[int] = Field(
        None,
