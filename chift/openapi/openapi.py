...
#   timestamp: 2024-08-26T07:48:37+00:00
...
class AppRoutersCommerceProductCategoryItem(BaseModel):
    id: str = Field(
...
class AppRoutersCommerceProductPriceItem(BaseModel):
    currency: str = Field(..., title="Currency")
...
class AppRoutersConnectionsPostConnectionItem(BaseModel):
    integrationid: Optional[int] = Field(
        None,
...
class AppRoutersIntegrationsPostConnectionItem(BaseModel):
    title: str = Field(..., title="Title")
...
class AppRoutersPosProductCategoryItem(BaseModel):
    id: str = Field(..., title="Id")
    name: str = Field(..., title="Name")
    description: Optional[str] = Field(None, title="Description")
    id_parent: Optional[str] = Field(
...
class AppRoutersPosProductPriceItem(BaseModel):
    unit_price: float = Field(..., title="Unit Price")
    tax_rate: Optional[float] = Field(None, title="Tax Rate")


class AppRoutersSyncsConnectionItem(BaseModel):
...
class ModelsPaymentPaymentStatus(Enum):
    pending = "pending"
    completed = "completed"
    canceled = "canceled"
    failed = "failed"
...
class ModelsPosPmsDiscountItem(BaseModel):
    name: Optional[str] = Field(None, title="Name")
    total: float = Field(..., title="Total")


class ModelsPosPmsPaymentStatus(Enum):
    Pending = "Pending"
    Completed = "Completed"
    Canceled = "Canceled"
    Failed = "Failed"
...
class ChiftPageProductCategoryItem(BaseModel):
    items: List[AppRoutersPosProductCategoryItem] = Field(..., title="Items")
    total: conint(ge=0) = Field(..., title="Total")
    page: conint(ge=1) = Field(..., title="Page")
    size: conint(ge=1) = Field(..., title="Size")
...
class IntegrationItem(BaseModel):
    ...
    post_connections: Optional[List[AppRoutersIntegrationsPostConnectionItem]] = Field(
        [],
...
class OrderLineProductVariantItem(BaseModel):
    ...
    name: str = Field(..., title="Name")
    categories: Optional[List[AppRoutersCommerceProductCategoryItem]] = Field(
        [], title="Categories"
    )
...
class PMSOrderLineItem(BaseModel):
    ...
    tax_rate: Optional[float] = Field(None, title="Tax Rate")
    description: Optional[str] = Field(None, title="Description")
    discounts: Optional[List[ModelsPosPmsDiscountItem]] = Field([], title="Discounts")
    product_id: Optional[str] = Field(
        None,
...
class PMSPaymentItem(BaseModel):
    ...
    status: Optional[ModelsPosPmsPaymentStatus] = "Unknown"
...
class POSProductItem(BaseModel):
    ...
    name: str = Field(..., title="Name")
    description: Optional[str] = Field(None, title="Description")
    prices: List[AppRoutersPosProductPriceItem] = Field(..., title="Prices")
...
class PaymentItemOut(BaseModel):
    ...
    status: ModelsPaymentPaymentStatus = Field(..., description="Payment status")
...
class ProductVariantItem(BaseModel):
    ...
    prices: Optional[List[AppRoutersCommerceProductPriceItem]] = Field(
        [], title="Prices"
    )
...
class AppRoutersConnectionsConnectionItem(BaseModel):
...
class AppRoutersAccountingChiftPageVatCode(BaseModel):
...
class AppRoutersInvoicingChiftPageVatCode(BaseModel):
...
class ReadSyncItem(BaseModel):
    name: constr(min_length=1) = Field(..., title="Name")
    connections: List[AppRoutersSyncsConnectionItem] = Field(..., title="Connections")
