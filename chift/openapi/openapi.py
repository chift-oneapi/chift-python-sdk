...
#   timestamp: 2026-07-24T15:32:27+00:00
...
class POSTaxRateItem(BaseModel):
    ...
    rate: Optional[float] = Field(
        None, description="Percentage of the tax rate", examples=[21], title="Rate"
    )
    tax_code: Optional[str] = Field(
        None,
...
class QueryMeta(BaseModel):
    ...
    currency: Optional[List[str]] = Field(None, title="Currency")
...
class PMSInvoiceFullItem(BaseModel):
    ...
    tax_amount: float = Field(
        ..., description="Taxes amount", examples=[21], title="Tax Amount"
    )
    untaxed_amount: float = Field(
        ..., description="Untaxed amount", examples=[100], title="Untaxed Amount"
    )
    total: float = Field(
        ..., description="Total amount incl. taxes", examples=[121], title="Total"
    )
