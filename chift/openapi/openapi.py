...
#   timestamp: 2026-02-17T13:49:02+00:00
...
class InvoicingVatCodeScope(Enum):
    nat = "nat"
    eu = "eu"
    int = "int"
    unknown = "unknown"
...
class InvoicingVatCodeType(Enum):
    sale = "sale"
    purchase = "purchase"
    both = "both"
    unknown = "unknown"
...
class InvoicingVatCode(BaseModel):
    ...
    type: InvoicingVatCodeType = Field(..., description="Type")
    code: Optional[str] = Field(None, description="Code", title="Code")
    scope: Optional[InvoicingVatCodeScope] = Field("unknown", description="Scope")
    active: Optional[bool] = Field(
