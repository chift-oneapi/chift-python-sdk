...
#   timestamp: 2026-09-09T19:30:43+00:00
...
class AccountingPaymentTerms(BaseModel):
    ...
    name: Optional[str] = Field(
        None, description="Name of the payment term", title="Name"
    )
...
class AnalyticDistributionDetailInvoicing(BaseModel):
    ...
    analytic_account_code: str = Field(
        ..., description="Code of the analytic account.", title="Analytic Account Code"
    )
    analytic_account_name: str = Field(
        ..., description="Name of the analytic account.", title="Analytic Account Name"
    )
    percentage: float = Field(
        ...,
        description="Percentage of the untaxed amount attributed to this analytic account. Only whole numbers (no decimals) are allowed. The total across the analytic distribution (all accounts in a given analytic plan) must equal 100%.",
...
class ContactItem(BaseModel):
    ...
    name: str = Field(..., description="Full name of the contact.", title="Name")
    first_name: Optional[str] = Field(
        None, description="First name of the contact.", title="First Name"
    )
    last_name: Optional[str] = Field(
        None, description="Last name of the contact.", title="Last Name"
    )
    function: Optional[str] = Field(
        None, description="Business role or job title of the contact.", title="Function"
    )
    email: Optional[str] = Field(
        None, description="Email address of the contact.", title="Email"
    )
    phone: Optional[str] = Field(
        None, description="Phone number of the contact.", title="Phone"
    )
    mobile: Optional[str] = Field(
        None, description="Mobile phone number of the contact.", title="Mobile"
    )
...
class ExpenseLineItem(BaseModel):
    ...
    total: float = Field(
        ..., description="Total amount for the line including taxes.", title="Total"
    )
    untaxed_amount: float = Field(
        ..., description="Untaxed amount for the line.", title="Untaxed Amount"
    )
    tax_amount: float = Field(
        ..., description="Tax amount for the line.", title="Tax Amount"
    )
    ...
    tax_rate: float = Field(
        ..., description="Tax rate (e.g., 21.0 for 21%).", title="Tax Rate"
    )
    tax_id: str = Field(
        ...,
...
class InvoicingPaymentItemIn(BaseModel):
    ...
    amount: float = Field(..., description="Payment amount", title="Amount")
    payment_method_id: Optional[str] = Field(
        None,
    ...
    date: Date = Field(..., description="The date of the payment", title="Date")
    description: Optional[str] = Field(
        None, description="Description of the payment", title="Description"
    )
    currency: str = Field(..., description="Currency of the payment", title="Currency")
...
class InvoicingPaymentItemUpdate(BaseModel):
    ...
    amount: Optional[float] = Field(None, description="Payment amount", title="Amount")
    payment_method_id: Optional[str] = Field(
        None,
        description="The technical ID of the payment method in the invoicing system",
        title="Payment Method Id",
    ...
    date: Optional[Date] = Field(
        None, description="The date of the payment", title="Date"
    )
    description: Optional[str] = Field(
        None, description="Description of the payment", title="Description"
    )
...
class ItemAttachmentInfoAttachment(BaseModel):
    ...
    filename: Optional[str] = Field(
        None, description="The name of the attachment.", title="Filename"
    )
...
class ModifierOptionItem(BaseModel):
    ...
    price: float = Field(..., description="Price of the modifier option", title="Price")
...
class OutstandingItemDueDatesOut(BaseModel):
    ...
    due_date: Date = Field(
        ..., description="Due date of the outstanding item.", title="Due Date"
    )
    payment_method: Optional[str] = Field(
        None,
...
class AccountingInvoicePaymentIn(BaseModel):
    ...
    currency: str = Field(..., description="Payment currency", title="Currency")
    currency_exchange_rate: Optional[float] = Field(
        1,
    ...
    reference: Optional[str] = Field(
        None, description="External reference of the payment.", title="Reference"
    )
    number: Optional[str] = Field(
        None,
...
class BalanceItemOut(BaseModel):
    ...
    create_date: Optional[DateTime] = Field(
        None, description="Create Date", title="Create Date"
    )
...
class BankTransactionItemIn(BaseModel):
    ...
    description: Optional[str] = Field(
        None, description="Transaction description", title="Description"
    )
    external_transaction_id: Optional[str] = Field(
        None, description="External transaction ID", title="External Transaction Id"
    )
    amount: float = Field(
        ..., description="Total amount including fee and tax", title="Amount"
    )
    fee_amount: Optional[float] = Field(0, description="Fee amount", title="Fee Amount")
    tax_amount: Optional[float] = Field(0, description="Tax amount", title="Tax Amount")
    currency_exchange_rate: Optional[float] = Field(
        1,
...
class ExpenseItemIn(BaseModel):
    ...
    total: float = Field(
        ..., description="Total amount including taxes for the expense.", title="Total"
    )
    untaxed_amount: float = Field(
        ..., description="Total untaxed amount for the expense.", title="Untaxed Amount"
    )
    tax_amount: float = Field(
        ..., description="Total tax amount for the expense.", title="Tax Amount"
    )
    reference: Optional[str] = Field(
        None, description="External reference.", title="Reference"
    )
    number: Optional[str] = Field(
        None,
    ...
    currency: str = Field(
        ..., description="Currency of the expense (e.g., EUR, USD).", title="Currency"
    )
    currency_exchange_rate: Optional[float] = Field(
        1,
    ...
    date: Date = Field(..., description="Expense date.", title="Date")
...
class InvoicingBankAccountItem(BaseModel):
    ...
    id: str = Field(..., description="Technical id in Chift", title="Id")
    source_ref: Ref = Field(..., description="Technical id in the target software")
    name: str = Field(..., description="Bank account name", title="Name")
    iban: Optional[str] = Field(None, description="IBAN", title="Iban")
    currency: Optional[str] = Field(
        None, description="Currency of the bank account", title="Currency"
    )
    balance: Optional[float] = Field(
        None, description="Current balance of the bank account", title="Balance"
    )
...
class LinkedDocument(BaseModel):
    ...
    source_ref: Ref = Field(..., description="Technical id in the target software")
    amount: float = Field(
        ..., description="Amount linked to the document", title="Amount"
    )
...
class PayoutItemOut(BaseModel):
    ...
    amount: float = Field(
        ..., description="Amount transferred to the merchant", title="Amount"
    )
    currency: str = Field(..., description="Currency", title="Currency")
    fee: Optional[float] = Field(
        None, description="Total fee applied by the processor", title="Fee"
    )
    extra_fee: Optional[float] = Field(
        None, description="Extra fee, if exposed by the processor", title="Extra Fee"
    )
    payment_date: Date = Field(
        ..., description="Date at which the payout was made", title="Payment Date"
    )
...
class BankStatementItemIn(BaseModel):
    ...
    bank_statement_date: Date = Field(
        ..., description="Date of the bank statement", title="Bank Statement Date"
    )
...
class InvoiceItemOutMonoAnalyticPlan(BaseModel):
    ...
    partner_id: Optional[str] = Field(..., title="Partner Id")
    journal_id: Optional[str] = Field(
        None,
...
class InvoicingBankTransactionItem(BaseModel):
    ...
    date: Date = Field(..., description="Transaction date", title="Date")
    description: Optional[str] = Field(
        None, description="Transaction description", title="Description"
    )
    currency: str = Field(
        ..., description="Currency of the transaction", title="Currency"
    )
    currency_exchange_rate: Optional[float] = Field(
        1.0,
    ...
    accounting_code: Optional[str] = Field(
        None, description="Accounting code", title="Accounting Code"
    )
...
class PMSAccountingTransactionItem(BaseModel):
    ...
    source_ref: Ref = Field(..., description="Technical id in the target software")
    group_id: str = Field(
        ..., description="Group id of the transaction", title="Group Id"
    )
    date: DateTime = Field(
        ...,
    ...
    is_tax_line: bool = Field(
        ..., description="Indicates the transaction is tax line", title="Is Tax Line"
    )
    sub_group_id: Optional[str] = Field(
        None, description="Sub group id of the transaction", title="Sub Group Id"
    )
    tax_code: Optional[str] = Field(
        None,
    ...
    description: Optional[str] = Field(
        "", description="Text description for this transaction.", title="Description"
    )
    currency_exchange_rate: Optional[float] = Field(
        1,
        description="Exchange rate applicable at the transaction date.",
...
class UploadDocumentItemOut(BaseModel):
    ...
    source_ref: Ref = Field(..., description="Technical id in the target software")
    currency: Optional[str] = Field(
        None, description="Currency of the uploaded document", title="Currency"
    )
    ...
    invoice_date: Optional[Date] = Field(
        None, description="Invoicing date", title="Invoice Date"
    )
    tax_amount: Optional[float] = Field(
        None, description="Taxes amount", title="Tax Amount"
    )
    untaxed_amount: Optional[float] = Field(
        None, description="Untaxed amount", title="Untaxed Amount"
    )
    total: Optional[float] = Field(
        None, description="Total amount incl. taxes", title="Total"
    )
