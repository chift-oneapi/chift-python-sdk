...
#   timestamp: 2026-02-18T12:42:59+00:00
...
class BankTransactionItemAccountType(Enum):
...
class BankTransactionItemIn(BaseModel):
    account_type: Optional[BankTransactionItemAccountType] = Field(
        None, description="Account type; mandatory if account is provided"
    )
    account: Optional[str] = Field(
        None, description="Account identifier", title="Account"
    )
    ...
    currency: constr(min_length=1) = Field(
        ..., description="Transaction currency", title="Currency"
    )
