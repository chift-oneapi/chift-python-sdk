...
## 0.6.13 - 2026-09-23
- pos: add `location_id` query parameter to get tax rates
...
## 0.3.29 - 2025-10-30
- accounting: add folder models and endpoints

## 0.3.28 - 2025-10-22
- invoicing: adapt analytic distribution in invoices retrieval model
